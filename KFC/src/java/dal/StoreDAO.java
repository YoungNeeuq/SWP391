...
public class StoreDAO {
    ...
    public void addStore(String store_name, String address, String timeOC, String image, String store_phoneNumber) {
        ...
        try {
            String sql = " Insert into Store (store_name, address,timeOC,image,store_phoneNumber)\n"
                    + "  values (?,?,?,?)";
            ...
            ps.setString(5, store_phoneNumber);
    ...
    public Store getStoreById(int store_id) {
        try {
            String sql = "select store_id,store_name,timeOC, image, store_phoneNumber from Store where store_id = ?";
            Connection connection = null;
            connection = db.getConnection();
    ...
    public void update(int store_id, String store_name, String address, String timeOC, String image, String phoneNumber) {
        Connection connection = null;
        PreparedStatement ps = null;
        
        try {
            String sql = "UPDATE Store "
                    + "SET store_name = ?, address = ?, timeOC = ?, store_phoneNumber = ?, image=? "
                    + "WHERE store_id = ?";
            connection = db.getConnection();
            ps = connection.prepareStatement(sql);
