    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="table-responsive">
                ...
                <div class="form-group" id="fault">
                    ...
                    <label><%=session.getAttribute("vnp_ResponseCode")%></label>
                ...
                <div class="form-group" >
                    <button  class="btn btn-primary" id="backButton"><a style="color: white" href="ProductServlet">Trở về</a></button>
                </div>
                <form action="CheckOutServlet" method="GET" id="checkoutForm">
                    ...
                    <c:forEach var="dish" items="${cart.getCartItems()}" varStatus="loop">
                        ...
                        <input type="hidden" name="cod" id="cod" value="3">
                    </c:forEach>
                    <button type="submit" class="btn btn-primary" id="confirmButton" style="display:none">Xác nhận</button>
                </form>
            </div>
            <p>
                &nbsp;
        ...
        <script>
            ...
            if (transactionStatus === "00") {
                // Nếu giao dịch thành công, tự động submit form
                document.getElementById("fault").style.display = "none";
                document.getElementById("checkoutForm").submit();
            } else {
                // Nếu giao dịch không thành công, không thực hiện checkoutServlet method GET
                document.getElementById("checkoutForm").setAttribute("action", "vnpay_return.jsp");
