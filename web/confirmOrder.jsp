...
Bạn có chắc chắn bạn muốn thoát??</h5>
        ...
        <button type="submit" class="btn btn-secondary mb-4" > <a style=" color: white; text-decoration: none;" href="ListProductServlet">Trở về </a></button>
                    ...
                    <tr> <!-- Thêm thẻ tr ở đây -->
                        ...
                        <td>
                            <form action="ViewDetailOrder" method="GET">
                                ...
                                <button type="submit" name="viewButton" value="view"class="btn btn-success" > Xem chi tiết
                                </button>
                            </form>
                        </td>
