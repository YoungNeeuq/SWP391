                ...
                <div class="row gx-5">
                    ...
                    <main class="col-lg-6">
                        <div class="ps-lg-3">
                            ...
                            <div class="d-flex" style="gap: 15px;">
                                <a href="ListProductCustomer#Menu" class="btn btn-success shadow-0"> Home </a>
                    ...
                    <div class="comment">
                        <c:forEach var="comment" items="${listComment}">
                            <label>${comment.getUsername()}</label><br>
                            ...
                            <p class="comment-date-faded" style="color: #888; font-size: 0.8em;">${formattedDateTime}</p>
                        </c:forEach>
